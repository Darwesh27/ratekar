...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ThoughtDraft.time'
        db.alter_column(u'timeline_thoughtdraft', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'ThoughtDraft.time'
        db.alter_column(u'timeline_thoughtdraft', 'time', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
