...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommentCondemn.condemned'
        db.add_column(u'timeline_commentcondemn', 'condemned',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommentCondemn.condemned'
        db.delete_column(u'timeline_commentcondemn', 'condemned')
