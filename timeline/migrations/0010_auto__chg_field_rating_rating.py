...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'timeline_rating', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Rating.rating'
        raise RuntimeError("Cannot reverse this migration. 'Rating.rating' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Rating.rating'
        db.alter_column(u'timeline_rating', 'rating', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'timeline.commentcondemn': {
            ...
            'condemned': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'friend': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
